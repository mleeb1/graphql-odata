...
namespace CarvedRock.Api.GraphQL.Types
{
    ...
    {
        public ProductType(ProductReviewRepository reviewRepository, SellerRepository sellerRepository, IDataLoaderContextAccessor dataLoaderAccessor)
        {
            Field(t => t.Id);
            Field(t => t.Name);
            ...
            Field<ListGraphType<SellerType>>(
                "sellers",
                resolve: context =>
                {
                    var loader =
                        dataLoaderAccessor.Context.GetOrAddCollectionBatchLoader<int, Seller>(
                            "GetSellersByProductId", sellerRepository.GetForProducts);
                    return loader.LoadAsync(context.Source.Id);
                });
        }
    }
