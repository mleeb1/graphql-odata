...
namespace CarvedRock.Api.Data.Migrations
{
    ...
    [Migration("20191108195007_20191108_Sellers")]
    partial class _20191108_Sellers
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarvedRock.Api.Data.Entities.Seller", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("CarvedRock.Api.Data.Entities.Seller", b =>
                {
                    b.HasOne("CarvedRock.Api.Data.Entities.Product")
                        .WithMany("Sellers")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
